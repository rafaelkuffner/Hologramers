...
public class VRCameraController : MonoBehaviour {
    ...
    void LateUpdate()
    {
        ...
        this.transform.localPosition +=  threshold;/* -childGO.transform.localPosition   new Vector3((-UnityEngine.XR.InputTracking.GetLocalPosition(UnityEngine.XR.XRNode.CenterEye).x),
